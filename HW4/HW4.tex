...
\]
\begin{flalign*}
P(x=1) &= \dfrac{6 \x 1 \x 1}{216} = \dfrac{6}{216} \text{, since there must be only 1 distinct number.} && \\
P(x=2) &= \dfrac{6 \x 5 \x 1}{216} = \dfrac{30}{216} \text{, since there must be 2 distinct numbers, and one repeated.} && \\
P(x=3) &= \dfrac{6 \x 5 \x 4}{216} = \dfrac{120}{216} \text{, since there must be 3 distinct numbers.} &&
\end{flalign*}
