...
\begin{tikzpicture}
    \begin{axis}[
        ...
        {(0,0) (1,0)};
        \addplot[mark=*,blue] coordinates {(1,1/36)};
        \addplot[mark=none,blue,thick] coordinates {(1,1/36) (2,1/36)};
        \addplot[mark=*,blue] coordinates {(2,4/9)};
        \addplot[mark=none,blue,thick] coordinates {(2,4/9) (3,4/9)};
        \addplot[mark=*,blue] coordinates {(3,1)};
        \addplot[mark=none,blue,thick] coordinates {(3,1) (4,1)};
    \end{axis}
\end{tikzpicture}
\end{center}
